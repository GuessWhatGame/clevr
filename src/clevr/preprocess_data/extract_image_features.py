...
out_file = "gw_resnetV1_101_{feature_name}_{size}".format(feature_name=args.feature_name, size=args.img_size)
    ...
    for one_set in args.set_type:
        ...
        for batch in tqdm(iterator):
            ...
            for ft, game in zip(feat, batch["raw"]):
                filename = os.path.join(out_dir, "{}.npz".format(game.picture.id))
